...
const generalLedgerController = {
  createChartOfAccounts: async (req, res) => {
    try {
      const result = await erpService.generalLedger.createChartOfAccounts(req.body);
  ...
  createGLAccount: async (req, res) => {
    try {
      const result = await erpService.generalLedger.createGLAccount(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  postJournalEntry: async (req, res) => {
    try {
      const result = await erpService.generalLedger.postJournalEntry(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  generateTrialBalance: async (req, res) => {
    try {
      ...
      const result = await erpService.generalLedger.generateTrialBalance(from_date, to_date, chart_id);
  ...
  generateBalanceSheet: async (req, res) => {
    try {
      ...
      const result = await erpService.generalLedger.generateBalanceSheet(as_of_date, chart_id);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  generateProfitLoss: async (req, res) => {
    try {
      const { from_date, to_date, chart_id } = req.query;
      const result = await erpService.generalLedger.generateProfitLoss(from_date, to_date, chart_id);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  analyzeFinancialsAI: async (req, res) => {
    try {
      const { from_date, to_date, chart_id } = req.query;
      const result = await erpService.generalLedger.analyzeFinancialsAI(from_date, to_date, chart_id);
      res.json({ success: true, data: result });
    } catch (error) {
...
const controllingController = {
  createCostCenter: async (req, res) => {
    try {
      const result = await erpService.controlling.createCostCenter(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createProfitCenter: async (req, res) => {
    try {
      const result = await erpService.controlling.createProfitCenter(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  postCostAllocation: async (req, res) => {
    try {
      const result = await erpService.controlling.postCostAllocation(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  generateCostCenterReport: async (req, res) => {
    try {
      ...
      const result = await erpService.controlling.generateCostCenterReport(cost_center_code, from_date, to_date);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  generateProfitCenterReport: async (req, res) => {
    try {
      ...
      const result = await erpService.controlling.generateProfitCenterReport(profit_center_code, from_date, to_date);
      res.json({ success: true, data: result });
    } catch (error) {
...
const materialsManagementController = {
  createMaterialMaster: async (req, res) => {
    try {
      const result = await erpService.materialsManagement.createMaterialMaster(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createPurchaseOrder: async (req, res) => {
    try {
      const result = await erpService.materialsManagement.createPurchaseOrder(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createGoodsReceipt: async (req, res) => {
    try {
      const result = await erpService.materialsManagement.createGoodsReceipt(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  getInventoryOverview: async (req, res) => {
    try {
      ...
      const result = await erpService.materialsManagement.getInventoryOverview(material_code, storage_location);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  optimizeSupplyChainAI: async (req, res) => {
    try {
      const { material_code, storage_location } = req.query;
      const result = await erpService.materialsManagement.optimizeSupplyChainAI(material_code, storage_location);
      res.json({ success: true, data: result });
    } catch (error) {
...
const salesDistributionController = {
  createCustomerMaster: async (req, res) => {
    try {
      const result = await erpService.salesDistribution.createCustomerMaster(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createSalesOrder: async (req, res) => {
    try {
      const result = await erpService.salesDistribution.createSalesOrder(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createDelivery: async (req, res) => {
    try {
      const result = await erpService.salesDistribution.createDelivery(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createInvoice: async (req, res) => {
    try {
      const result = await erpService.salesDistribution.createInvoice(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
...
const productionPlanningController = {
  createProductionOrder: async (req, res) => {
    try {
      const result = await erpService.productionPlanning.createProductionOrder(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  releaseProductionOrder: async (req, res) => {
    try {
      ...
      const result = await erpService.productionPlanning.releaseProductionOrder(production_order);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  confirmProductionOrder: async (req, res) => {
    try {
      const { production_order } = req.params;
      const result = await erpService.productionPlanning.confirmProductionOrder(production_order, req.body);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  optimizeProductionAI: async (req, res) => {
    try {
      ...
      const result = await erpService.productionPlanning.optimizeProductionAI(production_plant, from_date, to_date);
      res.json({ success: true, data: result });
    } catch (error) {
...
const qualityManagementController = {
  createInspectionLot: async (req, res) => {
    try {
      const result = await erpService.qualityManagement.createInspectionLot(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  recordInspectionResult: async (req, res) => {
    try {
      const result = await erpService.qualityManagement.recordInspectionResult(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  makeUsageDecision: async (req, res) => {
    try {
      ...
      const result = await erpService.qualityManagement.makeUsageDecision(inspection_lot, req.body);
      res.json({ success: true, data: result });
    } catch (error) {
...
const plantMaintenanceController = {
  createEquipmentMaster: async (req, res) => {
    try {
      const result = await erpService.plantMaintenance.createEquipmentMaster(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createMaintenanceOrder: async (req, res) => {
    try {
      const result = await erpService.plantMaintenance.createMaintenanceOrder(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  confirmMaintenanceOrder: async (req, res) => {
    try {
      ...
      const result = await erpService.plantMaintenance.confirmMaintenanceOrder(maintenance_order, req.body);
      res.json({ success: true, data: result });
    } catch (error) {
...
const humanResourcesController = {
  createEmployeeMaster: async (req, res) => {
    try {
      const result = await erpService.humanResources.createEmployeeMaster(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createOrganizationalUnit: async (req, res) => {
    try {
      const result = await erpService.humanResources.createOrganizationalUnit(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  processPayroll: async (req, res) => {
    try {
      const result = await erpService.humanResources.processPayroll(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  analyzeHRAI: async (req, res) => {
    try {
      ...
      const result = await erpService.humanResources.analyzeHRAI(period, year);
      res.json({ success: true, data: result });
    } catch (error) {
...
const projectSystemController = {
  createProjectDefinition: async (req, res) => {
    try {
      const result = await erpService.projectSystem.createProjectDefinition(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  createWBS: async (req, res) => {
    try {
      const result = await erpService.projectSystem.createWBS(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  updateProjectStatus: async (req, res) => {
    try {
      ...
      const result = await erpService.projectSystem.updateProjectStatus(project_code, req.body);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  analyzeProjectAI: async (req, res) => {
    try {
      const { project_code } = req.params;
      const result = await erpService.projectSystem.analyzeProjectAI(project_code);
      res.json({ success: true, data: result });
    } catch (error) {
...
const treasuryController = {
  createBankAccount: async (req, res) => {
    try {
      const result = await erpService.treasury.createBankAccount(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  recordCashFlow: async (req, res) => {
    try {
      const result = await erpService.treasury.recordCashFlow(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  getCashPosition: async (req, res) => {
    try {
      ...
      const result = await erpService.treasury.getCashPosition(as_of_date, currency);
      res.json({ success: true, data: result });
    } catch (error) {
...
const assetManagementController = {
  createFixedAsset: async (req, res) => {
    try {
      const result = await erpService.assetManagement.createFixedAsset(req.body);
      res.status(201).json({ success: true, data: result });
    } catch (error) {
  ...
  calculateDepreciation: async (req, res) => {
    try {
      ...
      const result = await erpService.assetManagement.calculateDepreciation(asset_code, from_date, to_date);
      res.json({ success: true, data: result });
    } catch (error) {
...
const businessIntelligenceController = {
  generateExecutiveDashboard: async (req, res) => {
    try {
      const { from_date, to_date } = req.query;
      const result = await erpService.businessIntelligence.generateExecutiveDashboard(from_date, to_date);
      res.json({ success: true, data: result });
    } catch (error) {
  ...
  generateProfitabilityAnalysis: async (req, res) => {
    try {
      ...
      const result = await erpService.businessIntelligence.generateProfitabilityAnalysis(from_date, to_date, profit_center_code);
      res.json({ success: true, data: result });
    } catch (error) {
