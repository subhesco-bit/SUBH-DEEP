...
CREATE INDEX idx_knowledge_nodes_external ON knowledge_nodes(external_id);
CREATE INDEX idx_knowledge_nodes_name ON knowledge_nodes USING gin(to_tsvector('english', name));
...
CREATE INDEX idx_knowledge_analytics_date ON knowledge_analytics(date);
