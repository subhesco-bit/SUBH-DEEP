...
CREATE INDEX IF NOT EXISTS idx_engineering_projects_fpo ON engineering_projects(fpo_id);
CREATE INDEX IF NOT EXISTS idx_engineering_projects_status ON engineering_projects(status);
CREATE INDEX IF NOT EXISTS idx_engineering_projects_type ON engineering_projects(project_type);
CREATE INDEX IF NOT EXISTS idx_engineering_projects_phase ON engineering_projects(phase);
CREATE INDEX IF NOT EXISTS idx_engineering_projects_location ON engineering_projects USING GIN(location);
CREATE INDEX IF NOT EXISTS idx_engineering_projects_tags ON engineering_projects USING GIN(tags);
...
CREATE INDEX IF NOT EXISTS idx_design_documents_type ON design_documents(document_type);
CREATE INDEX IF NOT EXISTS idx_design_documents_status ON design_documents(status);
CREATE INDEX IF NOT EXISTS idx_design_documents_version ON design_documents(version);
CREATE INDEX IF NOT EXISTS idx_design_documents_created_at ON design_documents(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_ai_analysis_design ON ai_analysis_results(design_id);
CREATE INDEX IF NOT EXISTS idx_ai_analysis_type ON ai_analysis_results(analysis_type);
CREATE INDEX IF NOT EXISTS idx_ai_analysis_status ON ai_analysis_results(processing_status);
...
CREATE TABLE IF NOT EXISTS boq_items (
  ...
  -- FK added at the end of this file: vendors is created ~800 lines below,
  -- and PostgreSQL executes top-to-bottom, so an inline REFERENCES here fails
  -- and takes the whole boq_items table with it.
  vendor_id UUID,
...
CREATE INDEX IF NOT EXISTS idx_boq_items_vendor ON boq_items(vendor_id);
...
CREATE INDEX IF NOT EXISTS idx_cost_estimates_type ON cost_estimates(estimate_type);
CREATE INDEX IF NOT EXISTS idx_cost_estimates_version ON cost_estimates(version);
...
CREATE INDEX IF NOT EXISTS idx_material_prices_validity ON material_prices(valid_from, valid_until);
...
CREATE INDEX IF NOT EXISTS idx_labor_rates_type ON labor_rates(labor_type);
CREATE INDEX IF NOT EXISTS idx_labor_rates_category ON labor_rates(skill_category);
CREATE INDEX IF NOT EXISTS idx_labor_rates_region ON labor_rates(region);
CREATE INDEX IF NOT EXISTS idx_labor_rates_validity ON labor_rates(valid_from, valid_until);
...
CREATE INDEX IF NOT EXISTS idx_equipment_rates_code ON equipment_rates(equipment_code);
CREATE INDEX IF NOT EXISTS idx_equipment_rates_category ON equipment_rates(category);
CREATE INDEX IF NOT EXISTS idx_equipment_rates_validity ON equipment_rates(valid_from, valid_until);
...
CREATE INDEX IF NOT EXISTS idx_project_schedules_type ON project_schedules(schedule_type);
CREATE INDEX IF NOT EXISTS idx_project_schedules_version ON project_schedules(version);
...
CREATE INDEX IF NOT EXISTS idx_schedule_activities_critical ON schedule_activities(is_critical);
...
CREATE INDEX IF NOT EXISTS idx_bim_models_design ON bim_models(design_id);
CREATE INDEX IF NOT EXISTS idx_bim_models_type ON bim_models(model_type);
CREATE INDEX IF NOT EXISTS idx_bim_models_lod ON bim_models(lod_level);
...
CREATE INDEX IF NOT EXISTS idx_cad_files_design ON cad_files(design_id);
CREATE INDEX IF NOT EXISTS idx_cad_files_type ON cad_files(drawing_type);
...
CREATE INDEX IF NOT EXISTS idx_digital_twin_sensors_project ON digital_twin_sensors(project_id);
CREATE INDEX IF NOT EXISTS idx_digital_twin_sensors_id ON digital_twin_sensors(sensor_id);
CREATE INDEX IF NOT EXISTS idx_digital_twin_sensors_type ON digital_twin_sensors(sensor_type);
CREATE INDEX IF NOT EXISTS idx_digital_twin_sensors_status ON digital_twin_sensors(status);
...
CREATE INDEX IF NOT EXISTS idx_digital_twin_data_project ON digital_twin_data(project_id);
CREATE INDEX IF NOT EXISTS idx_digital_twin_data_sensor ON digital_twin_data(sensor_id);
CREATE INDEX IF NOT EXISTS idx_digital_twin_data_timestamp ON digital_twin_data(timestamp DESC);
-- Composite index for efficient time-series queries
CREATE INDEX IF NOT EXISTS idx_digital_twin_data_sensor_time ON digital_twin_data(sensor_id, timestamp DESC);
...
CREATE INDEX IF NOT EXISTS idx_dpr_documents_project ON dpr_documents(project_id);
CREATE INDEX IF NOT EXISTS idx_dpr_documents_type ON dpr_documents(dpr_type);
CREATE INDEX IF NOT EXISTS idx_dpr_documents_status ON dpr_documents(submission_status);
CREATE INDEX IF NOT EXISTS idx_dpr_documents_created_at ON dpr_documents(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_tender_documents_project ON tender_documents(project_id);
CREATE INDEX IF NOT EXISTS idx_tender_documents_number ON tender_documents(tender_number);
CREATE INDEX IF NOT EXISTS idx_tender_documents_status ON tender_documents(status);
CREATE INDEX IF NOT EXISTS idx_tender_documents_deadline ON tender_documents(bid_submission_deadline);
...
CREATE INDEX IF NOT EXISTS idx_construction_progress_activity ON construction_progress(schedule_activity_id);
CREATE INDEX IF NOT EXISTS idx_construction_progress_date ON construction_progress(report_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_quality_checks_date ON quality_checks(check_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_drone_surveys_project ON drone_surveys(project_id);
CREATE INDEX IF NOT EXISTS idx_drone_surveys_type ON drone_surveys(survey_type);
CREATE INDEX IF NOT EXISTS idx_drone_surveys_date ON drone_surveys(flight_date DESC);
CREATE INDEX IF NOT EXISTS idx_drone_surveys_status ON drone_surveys(processing_status);
...
CREATE INDEX IF NOT EXISTS idx_facility_operations_project ON facility_operations(project_id);
CREATE INDEX IF NOT EXISTS idx_facility_operations_type ON facility_operations(operation_type);
CREATE INDEX IF NOT EXISTS idx_facility_operations_date ON facility_operations(operation_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_engineering_audit_project ON engineering_audit_log(project_id);
CREATE INDEX IF NOT EXISTS idx_engineering_audit_user ON engineering_audit_log(user_id);
CREATE INDEX IF NOT EXISTS idx_engineering_audit_entity ON engineering_audit_log(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_engineering_audit_timestamp ON engineering_audit_log(timestamp DESC);
...
DROP TRIGGER IF EXISTS update_material_prices_updated_at ON material_prices;
...
DROP TRIGGER IF EXISTS update_equipment_rates_updated_at ON equipment_rates;
...
DROP TRIGGER IF EXISTS update_schedule_activities_updated_at ON schedule_activities;
CREATE TRIGGER update_schedule_activities_updated_at BEFORE UPDATE ON schedule_activities
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_bim_models_updated_at ON bim_models;
CREATE TRIGGER update_bim_models_updated_at BEFORE UPDATE ON bim_models
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_cad_files_updated_at ON cad_files;
CREATE TRIGGER update_cad_files_updated_at BEFORE UPDATE ON cad_files
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_digital_twin_sensors_updated_at ON digital_twin_sensors;
...
DROP TRIGGER IF EXISTS update_drone_surveys_updated_at ON drone_surveys;
...
DROP TRIGGER IF EXISTS generate_project_number_trigger ON engineering_projects;
...
SELECT 
    ...
    p.created_at,
    p.updated_at,
    -- FIXED 2026-08-04: was u.name, which does not exist on users (that table
    -- holds email/phone/role only). The display name lives on
    -- user_profiles.full_name, a generated column. Same defect as the
    -- farmer_dashboard view in 000_base_schema.
...
-- Deferred FK (2026-08-04): boq_items.vendor_id -> vendors.id, added here
-- because vendors is defined later in this same file.
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'boq_items_vendor_id_fkey') THEN
    ALTER TABLE boq_items ADD CONSTRAINT boq_items_vendor_id_fkey
