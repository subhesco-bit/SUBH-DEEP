-- Folded from backend/src/modules/M082/model.sql (AUDIT_DB.md Finding 11/13 remediation)
-- Business Metrics & KPIs Tracking Schema (M082) / -- Business Intelligence & Analytics Module
...
CREATE INDEX IF NOT EXISTS idx_kpi_measurements_entity ON kpi_measurements(entity_id, entity_type);
...
CREATE INDEX IF NOT EXISTS idx_kpi_scores_entity ON kpi_scores(entity_id, entity_type);

CREATE INDEX IF NOT EXISTS idx_kpi_scores_period ON kpi_scores(period_start, period_end);

CREATE INDEX IF NOT EXISTS idx_metric_benchmarks_kpi ON metric_benchmarks(kpi_id);

CREATE INDEX IF NOT EXISTS idx_kpi_dimensions_kpi ON kpi_dimensions(kpi_id);

CREATE INDEX IF NOT EXISTS idx_kpi_aggregations_kpi ON kpi_aggregations(kpi_id);
