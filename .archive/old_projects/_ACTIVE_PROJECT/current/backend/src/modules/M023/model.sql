...
CREATE TABLE IF NOT EXISTS training_sessions (
    ...
    program_id VARCHAR(50) NOT NULL REFERENCES training_programs(program_id),
...
CREATE INDEX idx_farmer_enrollments_session ON farmer_enrollments(session_id);
CREATE INDEX idx_farmer_enrollments_farmer ON farmer_enrollments(farmer_id);
CREATE INDEX idx_farmer_enrollments_status ON farmer_enrollments(enrollment_status);
CREATE INDEX idx_assessment_results_assessment ON assessment_results(assessment_id);
CREATE INDEX idx_assessment_results_farmer ON assessment_results(farmer_id);
CREATE INDEX idx_training_attendance_session ON training_attendance(session_id);
CREATE INDEX idx_training_attendance_farmer ON training_attendance(farmer_id);
