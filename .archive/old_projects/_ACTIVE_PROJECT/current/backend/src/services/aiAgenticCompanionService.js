/**
 * aiAgenticCompanionService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/aiAgenticCompanionService.js
...
module.exports = require('./legacy/aiAgenticCompanionService.js');
