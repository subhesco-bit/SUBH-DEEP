/**
 * comprehensiveERPService (thin wrapper)
 *
 * (2026-09-08) Near-identical duplicate of
 * backend/src/services/legacy/comprehensiveERPService.js (only require-path depth and a
 ...
 * copy is backend/src/modules/M513100_COMPREHENSIVEERP/backend/service.js, which requires
...
module.exports = require('./legacy/comprehensiveERPService');
