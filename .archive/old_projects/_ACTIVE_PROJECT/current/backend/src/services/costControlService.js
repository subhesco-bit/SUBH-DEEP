/**
 * costControlService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/costControlService.js
...
module.exports = require('./legacy/costControlService.js');
