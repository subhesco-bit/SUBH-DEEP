/**
 * ecommerceAIService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/ecommerceAIService.js
...
module.exports = require('./legacy/ecommerceAIService.js');
