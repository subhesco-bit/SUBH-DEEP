/**
 * identityManagementService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/identityManagementService.js
...
module.exports = require('./legacy/identityManagementService.js');
