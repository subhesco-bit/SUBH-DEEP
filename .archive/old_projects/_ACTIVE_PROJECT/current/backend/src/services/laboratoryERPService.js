/**
 * laboratoryERPService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/laboratoryERPService.js
...
module.exports = require('./legacy/laboratoryERPService.js');
