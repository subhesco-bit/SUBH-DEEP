/**
 * mobilityRidesService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/mobilityRidesService.js
...
module.exports = require('./legacy/mobilityRidesService.js');
