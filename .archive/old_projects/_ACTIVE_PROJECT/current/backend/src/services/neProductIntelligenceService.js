/**
 * neProductIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/neProductIntelligenceService.js
...
module.exports = require('./legacy/neProductIntelligenceService.js');
