/**
 * regionalVarietyService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/regionalVarietyService.js
...
module.exports = require('./legacy/regionalVarietyService.js');
