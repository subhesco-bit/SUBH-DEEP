-- Poultry Management Schema (M123)
...
CREATE INDEX idx_poultry_registry_farmer ON poultry_registry(farmer_id);
CREATE INDEX idx_poultry_registry_breed ON poultry_registry(breed);
CREATE INDEX idx_poultry_registry_location ON poultry_registry(state, district);
CREATE INDEX idx_poultry_health_records_registry ON poultry_health_records(registry_id);
CREATE INDEX idx_poultry_performance_registry ON poultry_performance_tracking(registry_id);
CREATE INDEX idx_regional_poultry_health_location ON regional_poultry_health_patterns(state, district);
