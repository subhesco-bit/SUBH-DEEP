...
CREATE INDEX idx_rural_economic_units_user ON rural_economic_units(user_id);
CREATE INDEX idx_rural_economic_units_type ON rural_economic_units(reu_type);
CREATE INDEX idx_rural_economic_units_subtype ON rural_economic_units(reu_subtype);
CREATE INDEX idx_rural_economic_units_status ON rural_economic_units(status);
CREATE INDEX idx_rural_economic_units_location ON rural_economic_units USING GIN(location);
CREATE INDEX idx_rural_economic_units_tags ON rural_economic_units USING GIN(tags);
CREATE INDEX idx_rural_economic_units_created_at ON rural_economic_units(created_at DESC);
...
CREATE INDEX idx_household_economy_reu ON household_economy(reu_id);
CREATE INDEX idx_household_economy_subscription ON household_economy(subscription_id);
CREATE INDEX idx_household_economy_status ON household_economy(subscription_status);
...
CREATE INDEX idx_household_orders_reu ON household_orders(reu_id);
CREATE INDEX idx_household_orders_number ON household_orders(order_number);
CREATE INDEX idx_household_orders_status ON household_orders(status);
CREATE INDEX idx_household_orders_delivery ON household_orders(delivery_date, delivery_status);
...
CREATE INDEX idx_farm_consumables_reu ON farm_consumables(reu_id);
CREATE INDEX idx_farm_consumables_crop ON farm_consumables(crop_id);
CREATE INDEX idx_farm_consumables_type ON farm_consumables(input_type);
CREATE INDEX idx_farm_consumables_season ON farm_consumables(season, year);
CREATE INDEX idx_farm_consumables_subsidy ON farm_consumables(subsidy_eligible);
...
CREATE INDEX idx_machinery_access_reu ON machinery_access(reu_id);
CREATE INDEX idx_machinery_access_machinery ON machinery_access(machinery_id);
CREATE INDEX idx_machinery_access_booking ON machinery_access(booking_id);
CREATE INDEX idx_machinery_access_dates ON machinery_access(start_date, end_date);
CREATE INDEX idx_machinery_access_status ON machinery_access(status);
...
CREATE INDEX idx_shared_infrastructure_access_reu ON shared_infrastructure_access(reu_id);
CREATE INDEX idx_shared_infrastructure_access_infrastructure ON shared_infrastructure_access(infrastructure_id);
CREATE INDEX idx_shared_infrastructure_access_booking ON shared_infrastructure_access(booking_id);
CREATE INDEX idx_shared_infrastructure_access_dates ON shared_infrastructure_access(start_date, end_date);
CREATE INDEX idx_shared_infrastructure_access_status ON shared_infrastructure_access(status);
...
CREATE TABLE IF NOT EXISTS rural_enterprises (
  ...
  -- Financing
  subsidy_id UUID REFERENCES subsidy_applications(id) ON DELETE SET NULL,
  loan_id UUID REFERENCES loans(id) ON DELETE SET NULL,
  insurance_id UUID REFERENCES insurance_policies(id) ON DELETE SET NULL,
...
CREATE INDEX idx_rural_enterprises_reu ON rural_enterprises(reu_id);
CREATE INDEX idx_rural_enterprises_type ON rural_enterprises(enterprise_type);
CREATE INDEX idx_rural_enterprises_status ON rural_enterprises(status);
CREATE INDEX idx_rural_enterprises_project ON rural_enterprises(project_id);
CREATE INDEX idx_rural_enterprises_subsidy ON rural_enterprises(subsidy_id);
CREATE INDEX idx_rural_enterprises_loan ON rural_enterprises(loan_id);
...
CREATE INDEX idx_enterprise_feasibility_reu ON enterprise_feasibility_analysis(reu_id);
CREATE INDEX idx_enterprise_feasibility_enterprise ON enterprise_feasibility_analysis(enterprise_id);
CREATE INDEX idx_enterprise_feasibility_type ON enterprise_feasibility_analysis(enterprise_type);
CREATE INDEX idx_enterprise_feasibility_recommendation ON enterprise_feasibility_analysis(recommendation);
...
CREATE INDEX idx_renewable_energy_systems_reu ON renewable_energy_systems(reu_id);
CREATE INDEX idx_renewable_energy_systems_enterprise ON renewable_energy_systems(enterprise_id);
CREATE INDEX idx_renewable_energy_systems_type ON renewable_energy_systems(system_type);
CREATE INDEX idx_renewable_energy_systems_status ON renewable_energy_systems(status);
CREATE INDEX idx_renewable_energy_systems_subsidy ON renewable_energy_systems(subsidy_scheme);
...
CREATE INDEX idx_energy_generation_data_system ON energy_generation_data(system_id);
CREATE INDEX idx_energy_generation_data_date ON energy_generation_data(generation_date DESC);
...
CREATE INDEX idx_rural_finance_reu ON rural_finance(reu_id);
CREATE INDEX idx_rural_finance_enterprise ON rural_finance(enterprise_id);
CREATE INDEX idx_rural_finance_energy ON rural_finance(energy_system_id);
CREATE INDEX idx_rural_finance_number ON rural_finance(loan_number);
CREATE INDEX idx_rural_finance_type ON rural_finance(financial_product_type);
CREATE INDEX idx_rural_finance_status ON rural_finance(status);
CREATE INDEX idx_rural_finance_lender ON rural_finance(lender_id);
...
CREATE INDEX idx_financial_needs_assessment_reu ON financial_needs_assessment(reu_id);
CREATE INDEX idx_financial_needs_assessment_date ON financial_needs_assessment(assessment_date DESC);
...
CREATE INDEX idx_ai_advisories_reu ON ai_advisories(reu_id);
CREATE INDEX idx_ai_advisories_type ON ai_advisories(advisory_type);
CREATE INDEX idx_ai_advisories_crop ON ai_advisories(crop_id);
CREATE INDEX idx_ai_advisories_enterprise ON ai_advisories(enterprise_id);
CREATE INDEX idx_ai_advisories_date ON ai_advisories(created_at DESC);
CREATE INDEX idx_ai_advisories_followup ON ai_advisories(follow_up_required, follow_up_date);
...
CREATE INDEX idx_advisory_attachments_advisory ON advisory_attachments(advisory_id);
...
CREATE INDEX idx_market_access_reu ON market_access(reu_id);
CREATE INDEX idx_market_access_enterprise ON market_access(enterprise_id);
CREATE INDEX idx_market_access_produce ON market_access(produce_type);
CREATE INDEX idx_market_access_channel ON market_access(market_channel);
CREATE INDEX idx_market_access_date ON market_access(sale_date DESC);
CREATE INDEX idx_market_access_status ON market_access(status);
CREATE INDEX idx_market_access_buyer ON market_access(buyer_id);
...
CREATE INDEX idx_market_intelligence_produce ON market_intelligence(produce_type);
CREATE INDEX idx_market_intelligence_location ON market_intelligence USING GIN(location);
CREATE INDEX idx_market_intelligence_date ON market_intelligence(data_date DESC);
...
CREATE INDEX idx_reu_dashboard_summary ON reu_dashboard_summary(reu_id);
...
SELECT 
    ...
    COUNT(DISTINCT fc.financing_id) as financed_inputs,
    fc.season,
    fc.year
FROM rural_economic_units reu
