...
CREATE INDEX idx_gi_products_product ON gi_products(product_id);
CREATE INDEX idx_gi_products_region ON gi_products(geographical_region);
CREATE INDEX idx_gi_products_status ON gi_products(status);
...
CREATE INDEX idx_gi_producers_gi_product ON gi_producers(gi_product_id);
CREATE INDEX idx_gi_producers_producer ON gi_producers(producer_id);
...
CREATE INDEX idx_gi_verifications_producer ON gi_verifications(producer_id);
...
CREATE INDEX idx_gi_product_pricing_product ON gi_product_pricing(product_id);
...
CREATE INDEX idx_gi_authentication_code ON gi_authentication(authentication_code);
CREATE INDEX idx_gi_authentication_batch ON gi_authentication(batch_number);
...
CREATE INDEX idx_gi_marketplace_gi_product ON gi_marketplace_listings(gi_product_id);
CREATE INDEX idx_gi_marketplace_seller ON gi_marketplace_listings(seller_id);
CREATE INDEX idx_gi_marketplace_status ON gi_marketplace_listings(listing_status);
...
CREATE INDEX idx_gi_analytics_gi_product ON gi_analytics(gi_product_id);
CREATE INDEX idx_gi_analytics_date ON gi_analytics(date);
