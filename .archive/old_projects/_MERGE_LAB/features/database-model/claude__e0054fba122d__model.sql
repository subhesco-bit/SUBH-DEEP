-- Comparative Analytics Schema (M085)
...
CREATE INDEX idx_comparison_groups_type ON comparison_groups(group_type);
CREATE INDEX idx_comparison_configs_group ON comparison_configs(group_id);
CREATE INDEX idx_comparison_results_config ON comparison_results(config_id);
CREATE INDEX idx_comparison_results_date ON comparison_results(comparison_date);
CREATE INDEX idx_comparison_benchmarks_group ON comparison_benchmarks(group_id);
CREATE INDEX idx_comparison_trends_config ON comparison_trends(config_id);
CREATE INDEX idx_comparison_trends_entity ON comparison_trends(entity_id);
CREATE INDEX idx_comparison_alerts_config ON comparison_alerts(config_id);
CREATE INDEX idx_comparison_alerts_active ON comparison_alerts(is_active);
CREATE INDEX idx_comparison_snapshots_config ON comparison_snapshots(config_id);
