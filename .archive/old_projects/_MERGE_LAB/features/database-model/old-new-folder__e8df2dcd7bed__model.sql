-- Watershed Management Schema (M079)
...
CREATE INDEX idx_watershed_plans_id ON watershed_plans(watershed_id);
CREATE INDEX idx_watershed_plans_location ON watershed_plans(state, district);
CREATE INDEX idx_ecological_assessments_watershed ON ecological_assessments(watershed_id);
CREATE INDEX idx_hydrological_data_watershed ON hydrological_data(watershed_id);
CREATE INDEX idx_land_use_patterns_watershed ON land_use_patterns(watershed_id);
CREATE INDEX idx_biodiversity_inventory_watershed ON biodiversity_inventory(watershed_id);
CREATE INDEX idx_conservation_implementations_watershed ON conservation_implementations(watershed_id);
CREATE INDEX idx_watershed_health_watershed ON watershed_health_monitoring(watershed_id);
