...
/** Strategic API - contract farming, strategic partnerships, government subsidy.
 *  government sub-object added to back GovernmentSubsidyPage.jsx and the
 *  government/ stub pages built out against it — real backend at
 *  backend/src/routes/strategic/governmentSubsidyRoutes.js, mounted at
...
export const strategicAPI = {
  ...
  government: {
    ...
    checkEligibility: (data) => api.post('/strategic/government/eligibility', data),
    ...
    disburseApplication: (id, data) => api.post(`/strategic/government/applications/${id}/disburse`, data),
    ...
    getDashboard: () => api.get('/strategic/government/dashboard'),
  },
}
...
/** Biometric verification (backend/src/routes/biometric.js, backend/src/
 *  services/biometricService.js — real, writes to biometric_logs). Route
 *  file existed but was never mounted; mounted at /api/v1 in
 *  backend/src/index.js as part of building out BiometricAuthentication.jsx. */
export const biometricAPI = {
  verify: (userId, data) => api.post(`/biometric/verify/${userId}`, data),
}
