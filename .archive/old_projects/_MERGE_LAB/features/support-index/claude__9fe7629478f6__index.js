...
// Biometric verification route existed but was never mounted (no app.use
// anywhere, dynamicRouteLoader.js is not invoked from this file either) —
// mounted here for BiometricAuthentication.jsx (frontend/src/pages/government).
...
// biometric.js defines its own '/biometric/verify/:userId' path, so mount at
// the bare API root -> POST /api/v1/biometric/verify/:userId.
