...
app.use('/api/v1/clinical-nutrition', clinicalNutritionDecisionSupportService.router);
app.use('/api/v1/medical-coding-reference', medicalCodingReferenceService.router);
...
const expertRoleRoutes = require('./routes/expertRoleRoutes');
app.use('/api/v1/expert-roles', expertRoleRoutes);
