...
const ApplicationStatusTrackerPage = lazy(() => import('../pages/government/ApplicationStatusTracker'))
const BiometricAuthenticationPage = lazy(() => import('../pages/government/BiometricAuthentication'))
const DeadlineTrackerPage = lazy(() => import('../pages/government/DeadlineTracker'))
const SchemeEligibilityCheckerPage = lazy(() => import('../pages/government/SchemeEligibilityChecker'))
const SchemeVerificationPage = lazy(() => import('../pages/government/SchemeVerificationPage'))
const BeneficiaryManagementPage = lazy(() => import('../pages/government/BeneficiaryManagement'))
...
export const adminRoutes = [
  ...
  },
  {
    ...
    keywords: 'audit, report, security, compliance',
    transition: 'fade',
    role: 'admin'
  },
  {
    path: '/government/scheme-verification',
    component: SchemeVerificationPage,
    title: 'Scheme Verification - AFRERA',
    description: 'Mark verified government schemes active, conditional or expired',
    keywords: 'government, scheme, verification, registry',
    transition: 'fade',
    role: 'admin'
  },
  {
    path: '/government/beneficiary-management',
    component: BeneficiaryManagementPage,
    title: 'Beneficiary Management - AFRERA',
    description: 'Utilization, disbursement and impact metrics for subsidy program beneficiaries',
    keywords: 'government, subsidy, beneficiaries, impact',
    transition: 'fade',
    role: 'admin'
  }
]
...
export const managementRoutes = [
  ...
  },
  {
    ...
    title: 'Government Subsidy Programs - AFRERA',
    description: 'Apply for agricultural subsidies and track your application status',
    keywords: 'subsidy, government, application, farmer',
    transition: 'fade'
  },
  {
    path: '/government/application-tracker',
    component: ApplicationStatusTrackerPage,
    title: 'Application Status Tracker - AFRERA',
    description: 'Track the status of a government scheme application',
    keywords: 'government, application, tracker, status',
    transition: 'fade'
  },
  {
    path: '/government/biometric-authentication',
    component: BiometricAuthenticationPage,
    title: 'Biometric Authentication - AFRERA',
    description: 'Record a biometric verification event for a beneficiary or applicant',
    keywords: 'government, biometric, verification',
    transition: 'fade'
  },
  {
    path: '/government/deadline-tracker',
    component: DeadlineTrackerPage,
    title: 'Deadline Tracker - AFRERA',
    description: 'Verified government schemes approaching or past their expiry date',
    keywords: 'government, scheme, deadline, expiry',
    transition: 'fade'
  },
  {
    path: '/government/scheme-eligibility-checker',
    component: SchemeEligibilityCheckerPage,
    title: 'Scheme Eligibility Checker - AFRERA',
    description: 'Check which verified government schemes apply to you',
    keywords: 'government, scheme, eligibility',
    transition: 'fade'
  },
  {
    path: '/farm-costing',
