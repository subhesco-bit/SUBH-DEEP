-- Folded from backend/src/modules/M081/model.sql (AUDIT_DB.md Finding 11/13 remediation)
-- Data Visualization Dashboard Schema (M081) / -- Business Intelligence & Analytics Module
...
CREATE INDEX IF NOT EXISTS idx_dashboard_data_sources_dashboard ON dashboard_data_sources(dashboard_id);
...
CREATE INDEX IF NOT EXISTS idx_dashboard_usage_logs_dashboard ON dashboard_usage_logs(dashboard_id);

CREATE INDEX IF NOT EXISTS idx_dashboard_usage_logs_user ON dashboard_usage_logs(user_id);
