/**
 * complianceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/complianceService.js
...
module.exports = require('./legacy/complianceService.js');
