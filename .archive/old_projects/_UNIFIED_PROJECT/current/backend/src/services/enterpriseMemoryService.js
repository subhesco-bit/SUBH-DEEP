/**
 * enterpriseMemoryService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/enterpriseMemoryService.js
...
module.exports = require('./legacy/enterpriseMemoryService.js');
