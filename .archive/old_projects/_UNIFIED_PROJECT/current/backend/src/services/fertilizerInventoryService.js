/**
 * fertilizerInventoryService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/fertilizerInventoryService.js
...
module.exports = require('./legacy/fertilizerInventoryService.js');
