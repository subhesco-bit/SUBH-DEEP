/**
 * giIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/giIntelligenceService.js
...
module.exports = require('./legacy/giIntelligenceService.js');
