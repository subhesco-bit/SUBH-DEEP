/**
 * governmentSchemeService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/governmentSchemeService.js
...
module.exports = require('./legacy/governmentSchemeService.js');
