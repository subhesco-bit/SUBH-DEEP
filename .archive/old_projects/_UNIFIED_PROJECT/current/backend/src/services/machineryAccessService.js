/**
 * machineryAccessService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/machineryAccessService.js
...
module.exports = require('./legacy/machineryAccessService.js');
