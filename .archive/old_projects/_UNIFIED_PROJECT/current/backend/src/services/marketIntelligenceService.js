/**
 * marketIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/marketIntelligenceService.js
...
module.exports = require('./legacy/marketIntelligenceService.js');
