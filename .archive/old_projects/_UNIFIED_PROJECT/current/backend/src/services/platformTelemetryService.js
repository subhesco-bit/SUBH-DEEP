/**
 * platformTelemetryService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/platformTelemetryService.js
...
module.exports = require('./legacy/platformTelemetryService.js');
