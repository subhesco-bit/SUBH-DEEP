/**
 * villageProfileService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/villageProfileService.js
...
module.exports = require('./legacy/villageProfileService.js');
