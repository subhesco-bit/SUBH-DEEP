...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7RJ32oi.mjs");
...
var manifest = {
	"0db3d7d5e94e3e6be873546cb3053c2e8c7eb045c78d9150fe59d715c531a4b5": {
		functionName: "poolSell_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"2688d08b6e7aa35db610cf2e9141498c01e0a1c5f35ededbbc55a48f6a5419fb": {
		functionName: "getBooks_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"2d3d3046d306433b92abf45f6004bc128f2f8eaaf6ca06ef83eac29c9cda2b5e": {
		functionName: "bootOrganism_createServerFn_handler",
		importer: () => import("./fns-Y0x8uf-R.mjs")
	},
	"352e47ad70f0a1ddbb880cbac92806969ca1a4b3e401bdedff1e7921a016798a": {
		functionName: "pledgeLot_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"37af67cc9fb62a6106357ca94cde413b7beeaf6952d87964c28e829da42eaa59": {
		functionName: "clearLien_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"38fd788e9e3009183ef39ea1bf4b748cc86a5032cdfae83d06f1147ec718a2ec": {
		functionName: "publishSpineEvent_createServerFn_handler",
		importer: () => import("./fns-Y0x8uf-R.mjs")
	},
	"41ce23f4c07d6d2ff8a6518bc31c7d99f0d4afc2b2d35584d24c609e057609d4": {
		functionName: "sellLot_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"568f827d8c911d3703e13791351001e25e734bc03c251484e16acf9d2d27ee9a": {
		functionName: "recordHarvest_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"6b746126b9907148680b3a3c34bcec4d143d4401d4e7436f0f9da274f1c3b55a": {
		functionName: "getOrganism_createServerFn_handler",
		importer: () => import("./fns-Y0x8uf-R.mjs")
	},
	"7c8c0d0cadb856953f4e4826833471e9121bbc23ad297edbda4650a0a96e4fbd": {
		functionName: "consultModule_createServerFn_handler",
		importer: () => import("./fns-qW1NheIP.mjs")
	},
	"a33a11123d727690641395698b53da2d1d0220679ba258f125368f40911e01df": {
		functionName: "consultLibrary_createServerFn_handler",
		importer: () => import("./fns-Y0x8uf-R.mjs")
	},
	"a42ff5854486e8e8166773b62d59a281dd2917947c3b0855f1c01fb26cafc950": {
		functionName: "settleSale_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"a85b8899c73c46c9a950433013a58e8bed0b1d01b3c8233f71a615e62fcae027": {
		functionName: "enrollFarmer_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"aacbac26add35e7da9a5a5d7ada9a3dda9190c809f2df491f83646a118e4aa83": {
		functionName: "settlePoolSale_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"c2f2e699d6953cfd03c0b581c4d28c2362f9bb8903e321c840f390ed3e747a2c": {
		functionName: "getModuleOs_createServerFn_handler",
		importer: () => import("./fns-qW1NheIP.mjs")
	},
	"c8792138af86d97a726c912754d2d84cb15c581155c03d9916a350324f6cb58b": {
		functionName: "processDeclared_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"dc6571dfadb17ec4ff586f6f65db68b84a380a9fcb605f17cbf1747bb836fca6": {
		functionName: "getPlatform_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"e21747a4d61426cab3ed02ffd2732561067a0eb981a2788672f5c812c4f23ebd": {
		functionName: "recordInput_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"ee96b15a4fb0bfa0eaeccd047c9532f0a30854d271f687addfc8128616e65621": {
		functionName: "intakeLot_createServerFn_handler",
		importer: () => import("./fns-D-SOvwh1.mjs")
	},
	"fe434f95e71880a3a6a0efa77d4049d4af169c574c9a63a2260a377705c09d87": {
		functionName: "runModuleWorkflow_createServerFn_handler",
		importer: () => import("./fns-qW1NheIP.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-HRG5tEOq.mjs").then((n) => n.t),
