...
CREATE INDEX idx_translation_memory_languages ON translation_memory(source_language_id, target_language_id);
...
CREATE INDEX idx_content_translations_entity ON content_translations(entity_type, entity_id);
...
CREATE INDEX idx_detection_logs_user ON language_detection_logs(user_id);
CREATE INDEX idx_detection_logs_session ON language_detection_logs(session_id);
