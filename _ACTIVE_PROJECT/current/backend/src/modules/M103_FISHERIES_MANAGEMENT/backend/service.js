/**
 * Fisheries (M103_FISHERIES_MANAGEMENT)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/fisheriesService.js
...
module.exports = require('../../../backend/src/services/legacy/fisheriesService');
