/**
 * Bulk Order (M108100_BULKORDER)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/bulkOrderService.js
...
module.exports = require('../../../backend/src/services/legacy/bulkOrderService');
