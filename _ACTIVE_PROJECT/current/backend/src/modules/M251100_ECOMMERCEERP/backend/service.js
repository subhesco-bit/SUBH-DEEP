/**
 * Ecommerce E R P (M251100_ECOMMERCEERP)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/ecommerceERPService.js
...
module.exports = require('../../../backend/src/services/legacy/ecommerceERPService');
