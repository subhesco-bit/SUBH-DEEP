/**
 * Folu Benchmark (M735100_FOLUBENCHMARK)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/foluBenchmarkService.js
...
module.exports = require('../../../backend/src/services/legacy/foluBenchmarkService');
