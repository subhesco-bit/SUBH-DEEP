 ...
 *
 * Recovered from the ai-chat-copilot track's claude-worktree dump (a
 * substantial 566-line real file existed only there; the live version of
 * this exact path was a thin 38-line "Route operational" placeholder with
 * zero unique content, so it was safe to replace outright rather than
 * merge). Verified every method against the live
 * services/communityService.js before mounting. Added authMiddleware -
 * the recovered file had zero auth. Distinct from
 * communityManagementDomainRoutes.js (block/district/state/producerGroup
 * regional-hierarchy administration, backed by a different service,
 * communityManagementService.js) - this file is social/forum community
 * features (members, threads, groups, events, moderation, gamification).
 */
