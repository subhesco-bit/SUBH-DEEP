/**
 * assetAccountingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/assetAccountingService.js
...
module.exports = require('./legacy/assetAccountingService.js');
