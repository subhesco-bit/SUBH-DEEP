/**
 * cropValueResearchService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/cropValueResearchService.js
...
module.exports = require('./legacy/cropValueResearchService.js');
