/**
 * custodyEventService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/custodyEventService.js
...
module.exports = require('./legacy/custodyEventService.js');
