/**
 * ecommerceIntegrationService (thin wrapper)
 *
 * (2026-09-08) Near-identical duplicate of
 * backend/src/services/legacy/ecommerceIntegrationService.js (only require-path depth and a
 ...
 * copy is backend/src/modules/M406100_ECOMMERCEINTEGRATION/backend/service.js, which requires
...
module.exports = require('./legacy/ecommerceIntegrationService');
