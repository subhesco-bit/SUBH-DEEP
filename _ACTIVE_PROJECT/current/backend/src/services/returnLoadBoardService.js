/**
 * returnLoadBoardService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/returnLoadBoardService.js
...
module.exports = require('./legacy/returnLoadBoardService.js');
