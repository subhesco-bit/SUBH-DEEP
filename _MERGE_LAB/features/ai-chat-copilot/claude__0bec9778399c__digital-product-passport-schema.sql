...
CREATE INDEX idx_product_ids_product_id ON product_ids(product_id);
CREATE INDEX idx_product_ids_type ON product_ids(product_type);
CREATE INDEX idx_product_ids_category ON product_ids(product_category);
...
CREATE INDEX idx_batch_tracking_number ON batch_tracking(batch_number);
CREATE INDEX idx_batch_tracking_product ON batch_tracking(product_id);
...
CREATE INDEX idx_farm_info_product ON farm_information(product_id);
CREATE INDEX idx_farm_info_batch ON farm_information(batch_id);
CREATE INDEX idx_farm_info_farm ON farm_information(farm_id);
...
CREATE INDEX idx_farmer_info_product ON farmer_information(product_id);
CREATE INDEX idx_farmer_info_batch ON farmer_information(batch_id);
CREATE INDEX idx_farmer_info_farmer ON farmer_information(farmer_id);
...
CREATE INDEX idx_certification_info_product ON certification_information(product_id);
CREATE INDEX idx_certification_info_batch ON certification_information(batch_id);
CREATE INDEX idx_certification_info_type ON certification_information(certification_type);
...
CREATE INDEX idx_processing_history_product ON processing_history(product_id);
CREATE INDEX idx_processing_history_batch ON processing_history(batch_id);
CREATE INDEX idx_processing_history_facility ON processing_history(processing_facility_id);
...
CREATE INDEX idx_logistics_history_product ON logistics_history(product_id);
CREATE INDEX idx_logistics_history_batch ON logistics_history(batch_id);
CREATE INDEX idx_logistics_history_shipment ON logistics_history(shipment_id);
...
CREATE INDEX idx_sustainability_data_product ON sustainability_data(product_id);
CREATE INDEX idx_sustainability_data_batch ON sustainability_data(batch_id);
...
CREATE INDEX idx_carbon_data_product ON carbon_data(product_id);
CREATE INDEX idx_carbon_data_batch ON carbon_data(batch_id);
...
CREATE INDEX idx_quality_reports_product ON quality_reports(product_id);
...
CREATE INDEX idx_recall_status_product ON recall_status(product_id);
CREATE INDEX idx_recall_status_batch ON recall_status(batch_id);
CREATE INDEX idx_recall_status_recall ON recall_status(recall_id);
CREATE INDEX idx_recall_status_status ON recall_status(recall_status);
