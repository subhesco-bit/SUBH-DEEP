/**
 * Seed Vault (M109_SEED_MANAGEMENT)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/seedVaultService.js
...
module.exports = require('../../../backend/src/services/legacy/seedVaultService');
