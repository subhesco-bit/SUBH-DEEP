...
CREATE INDEX idx_species_scientific ON species_database(scientific_name);
CREATE INDEX idx_species_family ON species_database(family);
CREATE INDEX idx_species_genus ON species_database(genus);
CREATE INDEX idx_species_conservation ON species_database(conservation_status);
CREATE INDEX idx_species_habitat ON species_database USING GIN(habitat);
...
CREATE INDEX idx_native_crops_name ON native_crops_database(crop_name);
CREATE INDEX idx_native_crops_region ON native_crops_database(origin_region);
CREATE INDEX idx_native_crops_growing ON native_crops_database USING GIN(growing_regions);
CREATE INDEX idx_native_crops_conservation ON native_crops_database(conservation_status);
...
CREATE INDEX idx_traditional_varieties_name ON traditional_varieties_database(variety_name);
CREATE INDEX idx_traditional_varieties_crop ON traditional_varieties_database(crop_id);
CREATE INDEX idx_traditional_varieties_region ON traditional_varieties_database(region);
CREATE INDEX idx_traditional_varieties_conservation ON traditional_varieties_database(conservation_status);
...
CREATE INDEX idx_medicinal_plants_name ON medicinal_plants_database(plant_name);
CREATE INDEX idx_medicinal_plants_scientific ON medicinal_plants_database(scientific_name);
CREATE INDEX idx_medicinal_plants_family ON medicinal_plants_database(family);
CREATE INDEX idx_medicinal_plants_ailments ON medicinal_plants_database USING GIN(ailments_treated);
CREATE INDEX idx_medicinal_plants_conservation ON medicinal_plants_database(conservation_status);
...
CREATE INDEX idx_wild_foods_name ON wild_foods_database(food_name);
CREATE INDEX idx_wild_foods_type ON wild_foods_database(food_type);
CREATE INDEX idx_wild_foods_seasonal ON wild_foods_database USING GIN(seasonality);
CREATE INDEX idx_wild_foods_sustainability ON wild_foods_database(sustainability_status);
...
CREATE INDEX idx_conservation_species ON conservation_tracking(species_id);
CREATE INDEX idx_conservation_type ON conservation_tracking(species_type);
CREATE INDEX idx_conservation_status ON conservation_tracking(conservation_status);
...
CREATE INDEX idx_biodiversity_risk_species ON biodiversity_risk_predictions(species_id);
CREATE INDEX idx_biodiversity_risk_type ON biodiversity_risk_predictions(species_type);
CREATE INDEX idx_biodiversity_risk_region ON biodiversity_risk_predictions(region);
CREATE INDEX idx_biodiversity_risk_created ON biodiversity_risk_predictions(created_at DESC);
