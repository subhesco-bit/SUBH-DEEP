...
CREATE INDEX idx_land_parcels_village ON land_parcels(village_id);
CREATE INDEX idx_land_parcels_survey ON land_parcels(survey_number);
CREATE INDEX idx_land_parcels_type ON land_parcels(land_type);
CREATE INDEX idx_land_transfers_parcel ON land_transfers(parcel_id);
CREATE INDEX idx_land_transfers_from ON land_transfers(from_farmer_id);
CREATE INDEX idx_land_transfers_to ON land_transfers(to_farmer_id);
CREATE INDEX idx_land_records_parcel ON land_records(parcel_id);
