...
CREATE INDEX IF NOT EXISTS idx_gst_rates_category ON gst_rates(product_category);
CREATE INDEX IF NOT EXISTS idx_gst_rates_active ON gst_rates(is_active);
CREATE INDEX IF NOT EXISTS idx_gst_rates_hsn ON gst_rates(hsn_code);
...
CREATE INDEX IF NOT EXISTS idx_gst_calculations_order ON gst_calculations(order_id);
CREATE INDEX IF NOT EXISTS idx_gst_calculations_date ON gst_calculations(calculation_date);
...
CREATE INDEX IF NOT EXISTS idx_gst_invoices_customer_gst ON gst_invoices(customer_gst_number);
...
CREATE INDEX IF NOT EXISTS idx_gst_invoice_items_product ON gst_invoice_items(product_id);
...
CREATE INDEX IF NOT EXISTS idx_gst_returns_taxpayer ON gst_returns(taxpayer_gst_number);
CREATE INDEX IF NOT EXISTS idx_gst_returns_status ON gst_returns(return_status);
CREATE INDEX IF NOT EXISTS idx_gst_returns_filing_date ON gst_returns(filing_date);
...
CREATE INDEX IF NOT EXISTS idx_gst_payments_return ON gst_payments(return_id);
CREATE INDEX IF NOT EXISTS idx_gst_payments_type ON gst_payments(payment_type);
CREATE INDEX IF NOT EXISTS idx_gst_payments_status ON gst_payments(payment_status);
CREATE INDEX IF NOT EXISTS idx_gst_payments_date ON gst_payments(payment_date);
...
CREATE INDEX IF NOT EXISTS idx_gst_notifications_recipient ON gst_notifications(recipient_gst_number);
CREATE INDEX IF NOT EXISTS idx_gst_notifications_type ON gst_notifications(notification_type);
CREATE INDEX IF NOT EXISTS idx_gst_notifications_read ON gst_notifications(read_status);
...
CREATE INDEX IF NOT EXISTS idx_gst_compliance_entity ON gst_compliance_records(entity_id, entity_type);
CREATE INDEX IF NOT EXISTS idx_gst_compliance_type ON gst_compliance_records(compliance_type);
CREATE INDEX IF NOT EXISTS idx_gst_compliance_date ON gst_compliance_records(compliance_date);
CREATE INDEX IF NOT EXISTS idx_gst_compliance_gst ON gst_compliance_records(gst_number);
...
CREATE INDEX IF NOT EXISTS idx_gst_audit_entity ON gst_audit_logs(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_gst_audit_action ON gst_audit_logs(action_type);
CREATE INDEX IF NOT EXISTS idx_gst_audit_date ON gst_audit_logs(created_at);
CREATE INDEX IF NOT EXISTS idx_gst_audit_user ON gst_audit_logs(changed_by);
...
DROP TRIGGER IF EXISTS update_gst_rates_updated_at ON gst_rates;
...
DROP TRIGGER IF EXISTS update_gst_returns_updated_at ON gst_returns;
CREATE TRIGGER update_gst_returns_updated_at BEFORE UPDATE ON gst_returns
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_gst_payments_updated_at ON gst_payments;
CREATE TRIGGER update_gst_payments_updated_at BEFORE UPDATE ON gst_payments
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_gst_compliance_records_updated_at ON gst_compliance_records;
