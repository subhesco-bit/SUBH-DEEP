...
CREATE INDEX IF NOT EXISTS idx_procurement_orders_reu ON procurement_orders(reu_id);
CREATE INDEX IF NOT EXISTS idx_procurement_orders_club ON procurement_orders(buying_club_id);
CREATE INDEX IF NOT EXISTS idx_procurement_orders_number ON procurement_orders(order_number);
CREATE INDEX IF NOT EXISTS idx_procurement_orders_type ON procurement_orders(order_type);
CREATE INDEX IF NOT EXISTS idx_procurement_orders_status ON procurement_orders(status);
CREATE INDEX IF NOT EXISTS idx_procurement_orders_delivery ON procurement_orders(delivery_date, delivery_status);
...
CREATE INDEX IF NOT EXISTS idx_price_intelligence_source ON price_intelligence(source_type);
CREATE INDEX IF NOT EXISTS idx_price_intelligence_validity ON price_intelligence(valid_from, valid_to);
...
CREATE INDEX IF NOT EXISTS idx_buying_clubs_type ON buying_clubs(club_type);
CREATE INDEX IF NOT EXISTS idx_buying_clubs_location ON buying_clubs USING GIN (location);
CREATE INDEX IF NOT EXISTS idx_buying_clubs_status ON buying_clubs(status);
...
CREATE INDEX IF NOT EXISTS idx_procurement_subscriptions_reu ON procurement_subscriptions(reu_id);
CREATE INDEX IF NOT EXISTS idx_procurement_subscriptions_club ON procurement_subscriptions(buying_club_id);
CREATE INDEX IF NOT EXISTS idx_procurement_subscriptions_type ON procurement_subscriptions(subscription_type);
CREATE INDEX IF NOT EXISTS idx_procurement_subscriptions_status ON procurement_subscriptions(status);
CREATE INDEX IF NOT EXISTS idx_procurement_subscriptions_next_date ON procurement_subscriptions(next_procurement_date);
...
CREATE INDEX IF NOT EXISTS idx_logistics_orders_reu ON logistics_orders(reu_id);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_procurement ON logistics_orders(procurement_order_id);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_number ON logistics_orders(order_number);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_type ON logistics_orders(order_type);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_mode ON logistics_orders(selected_mode);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_status ON logistics_orders(status);
CREATE INDEX IF NOT EXISTS idx_logistics_orders_deadline ON logistics_orders(delivery_deadline);
...
CREATE INDEX IF NOT EXISTS idx_logistics_partners_type ON logistics_partners(partner_type);
CREATE INDEX IF NOT EXISTS idx_logistics_partners_subtype ON logistics_partners(partner_subtype);
CREATE INDEX IF NOT EXISTS idx_logistics_partners_status ON logistics_partners(status);
CREATE INDEX IF NOT EXISTS idx_logistics_partners_coverage ON logistics_partners USING GIN (coverage);
...
CREATE INDEX IF NOT EXISTS idx_last_mile_partners_reu ON last_mile_partners(reu_id);
CREATE INDEX IF NOT EXISTS idx_last_mile_partners_type ON last_mile_partners(partner_type);
CREATE INDEX IF NOT EXISTS idx_last_mile_partners_location ON last_mile_partners USING GIN (base_location);
CREATE INDEX IF NOT EXISTS idx_last_mile_partners_status ON last_mile_partners(status);
...
CREATE INDEX IF NOT EXISTS idx_reverse_logistics_reu ON reverse_logistics(reu_id);
CREATE INDEX IF NOT EXISTS idx_reverse_logistics_original ON reverse_logistics(original_order_id);
CREATE INDEX IF NOT EXISTS idx_reverse_logistics_type ON reverse_logistics(return_type);
CREATE INDEX IF NOT EXISTS idx_reverse_logistics_status ON reverse_logistics(status);
...
CREATE INDEX IF NOT EXISTS idx_backhaul_opportunities_partner ON backhaul_opportunities(logistics_partner_id);
CREATE INDEX IF NOT EXISTS idx_backhaul_opportunities_route ON backhaul_opportunities USING GIN (origin_location);
CREATE INDEX IF NOT EXISTS idx_backhaul_opportunities_availability ON backhaul_opportunities(available_from, available_until);
CREATE INDEX IF NOT EXISTS idx_backhaul_opportunities_status ON backhaul_opportunities(status);
...
CREATE INDEX IF NOT EXISTS idx_mobility_rides_reu ON mobility_rides(reu_id);
CREATE INDEX IF NOT EXISTS idx_mobility_rides_number ON mobility_rides(ride_number);
CREATE INDEX IF NOT EXISTS idx_mobility_rides_type ON mobility_rides(ride_type);
CREATE INDEX IF NOT EXISTS idx_mobility_rides_driver ON mobility_rides(driver_id);
CREATE INDEX IF NOT EXISTS idx_mobility_rides_departure ON mobility_rides(departure_time);
CREATE INDEX IF NOT EXISTS idx_mobility_rides_status ON mobility_rides(status);
...
CREATE INDEX IF NOT EXISTS idx_mobility_vehicles_reu ON mobility_vehicles(reu_id);
CREATE INDEX IF NOT EXISTS idx_mobility_vehicles_type ON mobility_vehicles(vehicle_type);
CREATE INDEX IF NOT EXISTS idx_mobility_vehicles_registration ON mobility_vehicles(registration_number);
CREATE INDEX IF NOT EXISTS idx_mobility_vehicles_location ON mobility_vehicles USING GIN (base_location);
CREATE INDEX IF NOT EXISTS idx_mobility_vehicles_status ON mobility_vehicles(status);
...
CREATE INDEX IF NOT EXISTS idx_safety_incidents_ride ON safety_incidents(ride_id);
CREATE INDEX IF NOT EXISTS idx_safety_incidents_reu ON safety_incidents(reu_id);
CREATE INDEX IF NOT EXISTS idx_safety_incidents_type ON safety_incidents(incident_type);
CREATE INDEX IF NOT EXISTS idx_safety_incidents_time ON safety_incidents(incident_time DESC);
...
CREATE INDEX IF NOT EXISTS idx_trust_scores_reu ON trust_scores(reu_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_system_savings_reu ON cross_system_savings(reu_id);
CREATE INDEX IF NOT EXISTS idx_cross_system_savings_period ON cross_system_savings(period_type, period_start, period_end);
...
CREATE INDEX IF NOT EXISTS idx_cross_system_orders_reu ON cross_system_orders(reu_id);
CREATE INDEX IF NOT EXISTS idx_cross_system_orders_procurement ON cross_system_orders(procurement_order_id);
CREATE INDEX IF NOT EXISTS idx_cross_system_orders_logistics ON cross_system_orders(logistics_order_id);
CREATE INDEX IF NOT EXISTS idx_cross_system_orders_mobility ON cross_system_orders(mobility_ride_id);
CREATE INDEX IF NOT EXISTS idx_cross_system_orders_status ON cross_system_orders(status);
...
DROP TRIGGER IF EXISTS update_price_intelligence_updated_at ON price_intelligence;
CREATE TRIGGER update_price_intelligence_updated_at BEFORE UPDATE ON price_intelligence
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_buying_clubs_updated_at ON buying_clubs;
CREATE TRIGGER update_buying_clubs_updated_at BEFORE UPDATE ON buying_clubs
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_procurement_subscriptions_updated_at ON procurement_subscriptions;
...
DROP TRIGGER IF EXISTS update_last_mile_partners_updated_at ON last_mile_partners;
CREATE TRIGGER update_last_mile_partners_updated_at BEFORE UPDATE ON last_mile_partners
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_reverse_logistics_updated_at ON reverse_logistics;
CREATE TRIGGER update_reverse_logistics_updated_at BEFORE UPDATE ON reverse_logistics
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_backhaul_opportunities_updated_at ON backhaul_opportunities;
CREATE TRIGGER update_backhaul_opportunities_updated_at BEFORE UPDATE ON backhaul_opportunities
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_mobility_rides_updated_at ON mobility_rides;
CREATE TRIGGER update_mobility_rides_updated_at BEFORE UPDATE ON mobility_rides
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_mobility_vehicles_updated_at ON mobility_vehicles;
CREATE TRIGGER update_mobility_vehicles_updated_at BEFORE UPDATE ON mobility_vehicles
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_cross_system_savings_updated_at ON cross_system_savings;
CREATE TRIGGER update_cross_system_savings_updated_at BEFORE UPDATE ON cross_system_savings
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_cross_system_orders_updated_at ON cross_system_orders;
...
DROP TRIGGER IF EXISTS generate_procurement_order_number_trigger ON procurement_orders;
...
DROP TRIGGER IF EXISTS generate_logistics_order_number_trigger ON logistics_orders;
...
DROP TRIGGER IF EXISTS generate_mobility_ride_number_trigger ON mobility_rides;
