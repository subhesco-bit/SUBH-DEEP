...
CREATE INDEX idx_sample_registrations_number ON sample_registrations(sample_number);
CREATE INDEX idx_sample_registrations_status ON sample_registrations(status);
CREATE INDEX idx_sample_registrations_lab ON sample_registrations(laboratory_id);
...
CREATE INDEX idx_test_assignments_sample ON test_assignments(sample_id);
