...
CREATE TABLE IF NOT EXISTS food_items (
    ...
    -- FK deferred to 999_schema_reconciliation: gi_products is created in
    -- 027_gi_intelligence_schema, which runs AFTER this file. An inline
    -- REFERENCES here fails with "relation gi_products does not exist".
    gi_id UUID,
...
CREATE INDEX IF NOT EXISTS idx_food_intelligence_food ON food_intelligence_analytics(food_item_id);
CREATE INDEX IF NOT EXISTS idx_food_intelligence_date ON food_intelligence_analytics(date);
...
DROP TRIGGER IF EXISTS update_food_recipes_updated_at ON food_recipes;
