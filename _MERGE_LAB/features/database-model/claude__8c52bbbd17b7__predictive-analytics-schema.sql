...
CREATE INDEX idx_predictions_entity ON predictions(target_entity_id, target_entity_type);
...
CREATE INDEX idx_forecasts_entity ON forecasts(entity_id, entity_type);
CREATE INDEX idx_forecasts_date ON forecasts(forecast_date);
CREATE INDEX idx_forecasts_model ON forecasts(generated_by_model_id);
...
CREATE INDEX idx_anomaly_detection_entity ON anomaly_detection(entity_id, entity_type);
CREATE INDEX idx_anomaly_detection_severity ON anomaly_detection(severity);
CREATE INDEX idx_anomaly_detection_resolved ON anomaly_detection(resolved);
...
CREATE INDEX idx_trend_analysis_entity ON trend_analysis(entity_id, entity_type);
CREATE INDEX idx_trend_analysis_period ON trend_analysis(analysis_period_start, analysis_period_end);
...
CREATE INDEX idx_what_if_scenarios_name ON what_if_scenarios(scenario_name);
CREATE INDEX idx_what_if_scenarios_type ON what_if_scenarios(scenario_type);
CREATE INDEX idx_what_if_scenarios_entity ON what_if_scenarios(entity_id, entity_type);
