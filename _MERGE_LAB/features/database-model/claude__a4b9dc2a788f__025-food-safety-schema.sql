...
CREATE INDEX IF NOT EXISTS idx_haccp_plans_facility ON haccp_plans(facility_id);
CREATE INDEX IF NOT EXISTS idx_haccp_plans_category ON haccp_plans(product_category);
...
CREATE INDEX IF NOT EXISTS idx_haccp_monitoring_plan ON haccp_monitoring_records(haccp_plan_id);
CREATE INDEX IF NOT EXISTS idx_haccp_monitoring_ccp ON haccp_monitoring_records(ccp_id);
CREATE INDEX IF NOT EXISTS idx_haccp_monitoring_time ON haccp_monitoring_records(monitoring_time DESC);
...
CREATE INDEX IF NOT EXISTS idx_fssai_license ON fssai_compliance(license_number);
CREATE INDEX IF NOT EXISTS idx_fssai_facility ON fssai_compliance(facility_id);
CREATE INDEX IF NOT EXISTS idx_fssai_status ON fssai_compliance(compliance_status);
...
CREATE INDEX IF NOT EXISTS idx_iso22000_certificate ON iso22000_compliance(certificate_number);
CREATE INDEX IF NOT EXISTS idx_iso22000_facility ON iso22000_compliance(facility_id);
CREATE INDEX IF NOT EXISTS idx_iso22000_status ON iso22000_compliance(status);
...
CREATE INDEX IF NOT EXISTS idx_food_safety_recalls_product ON food_safety_recalls(product_id);
CREATE INDEX IF NOT EXISTS idx_food_safety_recalls_batch ON food_safety_recalls(batch_number);
CREATE INDEX IF NOT EXISTS idx_food_safety_recalls_status ON food_safety_recalls(status);
CREATE INDEX IF NOT EXISTS idx_food_safety_recalls_risk ON food_safety_recalls(risk_level);
...
CREATE INDEX IF NOT EXISTS idx_capa_source ON capa_records(source_type, source_id);
CREATE INDEX IF NOT EXISTS idx_capa_status ON capa_records(status);
CREATE INDEX IF NOT EXISTS idx_capa_responsibility ON capa_records(responsibility);
...
CREATE INDEX IF NOT EXISTS idx_food_safety_audits_facility ON food_safety_audits(facility_id);
CREATE INDEX IF NOT EXISTS idx_food_safety_audits_type ON food_safety_audits(audit_type);
CREATE INDEX IF NOT EXISTS idx_food_safety_audits_date ON food_safety_audits(actual_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_food_safety_risk_facility ON food_safety_risk_assessments(facility_id);
CREATE INDEX IF NOT EXISTS idx_food_safety_risk_product ON food_safety_risk_assessments(product_id);
CREATE INDEX IF NOT EXISTS idx_food_safety_risk_level ON food_safety_risk_assessments(risk_level);
...
CREATE INDEX IF NOT EXISTS idx_corrective_actions_responsibility ON corrective_actions(responsibility);
...
DROP TRIGGER IF EXISTS update_haccp_plans_updated_at ON haccp_plans;
CREATE TRIGGER update_haccp_plans_updated_at BEFORE UPDATE ON haccp_plans
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_fssai_compliance_updated_at ON fssai_compliance;
CREATE TRIGGER update_fssai_compliance_updated_at BEFORE UPDATE ON fssai_compliance
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_iso22000_compliance_updated_at ON iso22000_compliance;
CREATE TRIGGER update_iso22000_compliance_updated_at BEFORE UPDATE ON iso22000_compliance
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_food_safety_recalls_updated_at ON food_safety_recalls;
CREATE TRIGGER update_food_safety_recalls_updated_at BEFORE UPDATE ON food_safety_recalls
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_capa_records_updated_at ON capa_records;
CREATE TRIGGER update_capa_records_updated_at BEFORE UPDATE ON capa_records
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_food_safety_audits_updated_at ON food_safety_audits;
CREATE TRIGGER update_food_safety_audits_updated_at BEFORE UPDATE ON food_safety_audits
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_food_safety_risk_assessments_updated_at ON food_safety_risk_assessments;
