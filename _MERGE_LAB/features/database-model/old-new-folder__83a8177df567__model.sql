-- Animal Health Management Schema (M127)
...
CREATE INDEX idx_animal_health_records_animal ON animal_health_records(animal_id);
CREATE INDEX idx_animal_health_records_farmer ON animal_health_records(farmer_id);
CREATE INDEX idx_vaccination_schedules_animal ON vaccination_schedules(animal_id);
CREATE INDEX idx_vaccination_schedules_date ON vaccination_schedules(scheduled_date);
CREATE INDEX idx_regional_disease_patterns_location ON regional_disease_patterns(state, district);
CREATE INDEX idx_animal_registry_farmer ON animal_registry(farmer_id);
CREATE INDEX idx_herd_health_monitoring_farmer ON herd_health_monitoring(farmer_id);
