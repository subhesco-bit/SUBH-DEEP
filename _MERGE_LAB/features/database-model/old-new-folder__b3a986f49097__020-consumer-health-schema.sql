...
CREATE INDEX IF NOT EXISTS idx_dietary_profiles_user ON dietary_profiles(user_id);
...
CREATE INDEX IF NOT EXISTS idx_dietary_recommendations_user ON dietary_recommendations(user_id);
...
CREATE INDEX IF NOT EXISTS idx_health_alerts_read ON health_alerts(is_read);
...
CREATE INDEX IF NOT EXISTS idx_food_consumption_logs_user ON food_consumption_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_food_consumption_logs_date ON food_consumption_logs(consumed_at);
...
CREATE INDEX IF NOT EXISTS idx_health_analytics_date ON health_analytics(date);
...
DROP TRIGGER IF EXISTS update_dietary_profiles_updated_at ON dietary_profiles;
