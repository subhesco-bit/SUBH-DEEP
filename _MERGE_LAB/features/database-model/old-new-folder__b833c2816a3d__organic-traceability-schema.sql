...
CREATE INDEX idx_organic_farms_farmer ON organic_farms(farmer_id);
CREATE INDEX idx_organic_farms_status ON organic_farms(certification_status);
...
CREATE INDEX idx_organic_plots_farm ON organic_plots(organic_farm_id);
...
CREATE INDEX idx_chain_of_custody_product ON organic_chain_of_custody(product_id);
CREATE INDEX idx_chain_of_custody_lot ON organic_chain_of_custody(lot_number);
...
CREATE INDEX idx_consumer_transparency_qr ON organic_consumer_transparency(qr_code);
