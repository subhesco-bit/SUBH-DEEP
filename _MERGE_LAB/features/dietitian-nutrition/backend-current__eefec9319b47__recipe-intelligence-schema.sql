...
CREATE INDEX idx_recipe_name ON recipe_database(recipe_name);
CREATE INDEX idx_recipe_cuisine ON recipe_database(cuisine_type);
CREATE INDEX idx_recipe_meal ON recipe_database(meal_type);
CREATE INDEX idx_recipe_difficulty ON recipe_database(difficulty_level);
CREATE INDEX idx_recipe_dietary ON recipe_database USING GIN(dietary_restrictions);
CREATE INDEX idx_recipe_allergens ON recipe_database USING GIN(allergens);
CREATE INDEX idx_recipe_seasonal ON recipe_database USING GIN(seasonal_availability);
CREATE INDEX idx_recipe_region ON recipe_database(region);
...
CREATE INDEX idx_ingredient_substitutions_substitute ON ingredient_substitutions(substitute);
CREATE INDEX idx_ingredient_substitutions_cuisine ON ingredient_substitutions(cuisine_type);
...
CREATE INDEX idx_ingredient_pricing_ingredient ON ingredient_pricing(ingredient);
CREATE INDEX idx_ingredient_pricing_category ON ingredient_pricing(category);
CREATE INDEX idx_ingredient_pricing_location ON ingredient_pricing(location);
...
CREATE INDEX idx_seasonal_ingredients_ingredient ON seasonal_ingredients(ingredient);
CREATE INDEX idx_seasonal_ingredients_season ON seasonal_ingredients(season);
CREATE INDEX idx_seasonal_ingredients_region ON seasonal_ingredients(region);
...
CREATE INDEX idx_regional_cuisine_region ON regional_cuisine(region);
CREATE INDEX idx_regional_cuisine_state ON regional_cuisine(state);
...
CREATE INDEX idx_institutional_recipes_institution ON institutional_recipes(institution_id);
CREATE INDEX idx_institutional_recipes_meal ON institutional_recipes(meal_type);
CREATE INDEX idx_institutional_recipes_status ON institutional_recipes(status);
...
CREATE INDEX idx_institutional_substitutions_institution ON institutional_ingredient_substitutions(institution_id);
CREATE INDEX idx_institutional_substitutions_original ON institutional_ingredient_substitutions(original_ingredient);
...
CREATE INDEX idx_institutional_nutrition_institution ON institutional_nutrition_requirements(institution_id);
CREATE INDEX idx_institutional_nutrition_meal ON institutional_nutrition_requirements(meal_type);
