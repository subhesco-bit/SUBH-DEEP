...
-- Earlier marketplace migrations create product_reviews with a smaller
-- column set. Evolve that canonical table explicitly before indexing it.
...
-- Migration 009 already owns bulk_orders with user_id/product_id. Add the
-- ecommerce projection fields explicitly and preserve the canonical UUID key.
