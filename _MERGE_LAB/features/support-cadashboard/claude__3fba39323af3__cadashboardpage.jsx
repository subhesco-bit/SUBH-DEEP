...
import { Calculator, FileText, Shield, Users, CheckCircle, BarChart3, Activity, Building2 } from 'lucide-react'
...
function CADashboardPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 border border-indigo-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg p-4">
                ...
                <div className="text-xs text-gray-500">Requiring review this month</div>
              </div>
              <div className="bg-white rounded-lg p-4">
                ...
                <div className="text-xs text-gray-500">Through optimization</div>
              </div>
              <div className="bg-white rounded-lg p-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="border rounded-lg p-4">
              <h4 className="font-medium text-gray-800 mb-2">GST Compliance</h4>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">TDS Collected</span>
                  <span className="font-medium text-green-600">₹1.2Cr</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">TDS Deposited</span>
                  <span className="font-medium text-green-600">₹1.1Cr</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Pending Filing</span>
                  <span className="font-medium text-orange-600">3 returns</span>
                </div>
              </div>
            </div>
          </div>
          <div className="text-center py-8 text-gray-500">
            Full tax compliance interface would be implemented here
          </div>
        </div>
      )}
      ...
      {activeTab === 'fpo' && (
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">FPO Accounting</h3>
