...
export const managementRoutes = [
  ...
  {
    path: '/about', component: AboutPage, title: 'About - AFRERA', transition: 'fade'
  },
  {
    path: '/advanced-analytics', component: AdvancedAnalyticsDashboard, title: 'Advanced Analytics - AFRERA', transition: 'fade'
  },
  {
    path: '/blockchain-verification', component: BlockchainVerificationPage, title: 'Blockchain Verification - AFRERA', transition: 'fade'
  },
  {
    path: '/contract-farming', component: ContractFarmingPage, title: 'Contract Farming - AFRERA', transition: 'fade'
  },
  {
    path: '/copilot', component: CopilotHubPage, title: 'AI Copilot - AFRERA', transition: 'fade'
  },
  {
    path: '/digital-twin', component: DigitalTwinPage, title: 'Digital Twin - AFRERA', transition: 'fade'
  },
  {
    path: '/enterprise-integration', component: EnterpriseIntegrationPage, title: 'Enterprise Integration - AFRERA', transition: 'fade'
  },
  {
    path: '/financial-services', component: FinancialServicesDashboard, title: 'Financial Services - AFRERA', transition: 'fade'
  },
  {
    path: '/government-subsidies', component: GovernmentSubsidyPage, title: 'Government Subsidies - AFRERA', transition: 'fade'
  },
  {
    path: '/household-procurement', component: HouseholdProcurementPage, title: 'Household Procurement - AFRERA', transition: 'fade'
  },
  {
    path: '/insurance-management', component: InsuranceManagementPage, title: 'Insurance Management - AFRERA', transition: 'fade'
  },
  {
    path: '/iot-monitoring', component: IoTMonitoringDashboard, title: 'IoT Monitoring - AFRERA', transition: 'fade'
  },
  {
    path: '/loans', component: LoanManagementPage, title: 'Loan Management - AFRERA', transition: 'fade'
  },
  {
    path: '/operations', component: OperationalDashboard, title: 'Operations - AFRERA', transition: 'fade'
  },
  {
    path: '/payments', component: PaymentProcessingPage, title: 'Payment Processing - AFRERA', transition: 'fade'
  },
  {
    path: '/predictive-intelligence', component: PredictiveIntelligencePage, title: 'Predictive Intelligence - AFRERA', transition: 'fade'
  },
  {
    path: '/pre-season-purchase', component: PreSeasonPurchasePage, title: 'Pre-Season Purchase - AFRERA', transition: 'fade'
  },
  {
    path: '/economic-dashboard', component: EconomicDashboard, title: 'Economic Dashboard - AFRERA', transition: 'fade'
  }
]
