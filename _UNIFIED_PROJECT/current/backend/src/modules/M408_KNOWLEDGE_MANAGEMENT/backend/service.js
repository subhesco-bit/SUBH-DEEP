/**
 * Knowledge (M408_KNOWLEDGE_MANAGEMENT)
 *
 * Thin wrapper - the real implementation lives in the live, already-mounted
 * service at ../backend/src/services/legacy/knowledgeService.js
...
module.exports = require('../../../backend/src/services/legacy/knowledgeService');
