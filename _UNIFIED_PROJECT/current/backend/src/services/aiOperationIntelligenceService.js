/**
 * aiOperationIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/aiOperationIntelligenceService.js
...
module.exports = require('./legacy/aiOperationIntelligenceService.js');
