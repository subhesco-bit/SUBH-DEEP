/**
 * blockchainTraceabilityService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/blockchainTraceabilityService.js
...
module.exports = require('./legacy/blockchainTraceabilityService.js');
