/**
 * civilDisruptionService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/civilDisruptionService.js
...
module.exports = require('./legacy/civilDisruptionService.js');
