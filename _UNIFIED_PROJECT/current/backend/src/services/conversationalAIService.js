/**
 * conversationalAIService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/conversationalAIService.js
...
module.exports = require('./legacy/conversationalAIService.js');
