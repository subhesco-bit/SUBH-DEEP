/**
 * defenseFitnessPrepService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/defenseFitnessPrepService.js
...
module.exports = require('./legacy/defenseFitnessPrepService.js');
