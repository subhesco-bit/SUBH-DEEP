/**
 * enterpriseControlService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/enterpriseControlService.js
...
module.exports = require('./legacy/enterpriseControlService.js');
