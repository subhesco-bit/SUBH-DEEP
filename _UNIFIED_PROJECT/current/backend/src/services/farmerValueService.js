/**
 * farmerValueService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/farmerValueService.js
...
module.exports = require('./legacy/farmerValueService.js');
