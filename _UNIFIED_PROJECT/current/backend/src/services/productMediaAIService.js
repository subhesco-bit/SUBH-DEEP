/**
 * productMediaAIService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/productMediaAIService.js
...
module.exports = require('./legacy/productMediaAIService.js');
