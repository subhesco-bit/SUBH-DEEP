/**
 * recipeIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/recipeIntelligenceService.js
...
module.exports = require('./legacy/recipeIntelligenceService.js');
