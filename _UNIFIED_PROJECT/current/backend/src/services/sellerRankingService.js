/**
 * sellerRankingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/sellerRankingService.js
...
module.exports = require('./legacy/sellerRankingService.js');
