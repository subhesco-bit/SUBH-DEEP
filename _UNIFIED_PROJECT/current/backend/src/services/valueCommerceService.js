/**
 * valueCommerceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/valueCommerceService.js
...
module.exports = require('./legacy/valueCommerceService.js');
