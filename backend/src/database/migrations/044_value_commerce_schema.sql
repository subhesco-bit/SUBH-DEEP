...
CREATE INDEX IF NOT EXISTS idx_product_value_scores_product ON product_value_scores(product_id);
...
CREATE INDEX IF NOT EXISTS idx_product_value_pricing_product ON product_value_pricing(product_id);
...
CREATE INDEX IF NOT EXISTS idx_consumer_value_preferences_user ON consumer_value_preferences(user_id);
...
CREATE INDEX IF NOT EXISTS idx_value_recommendations_user ON value_recommendations(user_id);
CREATE INDEX IF NOT EXISTS idx_value_recommendations_product ON value_recommendations(product_id);
...
CREATE INDEX IF NOT EXISTS idx_value_commerce_analytics_date ON value_commerce_analytics(date);
...
DROP TRIGGER IF EXISTS update_consumer_value_preferences_updated_at ON consumer_value_preferences;
