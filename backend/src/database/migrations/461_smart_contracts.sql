...
-- smart_contracts: winner is 015_advanced_features.sql
ALTER TABLE smart_contracts ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE smart_contracts ADD COLUMN IF NOT EXISTS data JSONB;
