...
-- sensor_data: winner is 031_iot_integration_schema.sql
ALTER TABLE sensor_data ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE sensor_data ADD COLUMN IF NOT EXISTS status VARCHAR(50);
ALTER TABLE sensor_data ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP;
ALTER TABLE sensor_data ADD COLUMN IF NOT EXISTS data JSONB;
...
-- a database where the wider definition already won.
-- sensor_data: winner is 031_iot_integration_schema.sql
ALTER TABLE sensor_data ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP;
