...
CREATE INDEX IF NOT EXISTS idx_soil_samples_parcel ON soil_samples(parcel_id);

CREATE INDEX IF NOT EXISTS idx_soil_samples_date ON soil_samples(sample_date);
