...
-- soil_samples: winner is 9510_m032_land_records_extra.sql
ALTER TABLE soil_samples ADD COLUMN IF NOT EXISTS status VARCHAR(50);
...
-- soil_health_cards: winner is 9999_zzzzzzzzzzzzzzzzzzzz_soil_management_schema.sql
