...
-- vendors: winner is 023_engineering_schema.sql
ALTER TABLE vendors ADD COLUMN IF NOT EXISTS risk_level VARCHAR(20);
ALTER TABLE vendors ADD COLUMN IF NOT EXISTS created_by UUID;
-- supply_chain_nodes: winner is 3008_phase3_supply_chain.sql
ALTER TABLE supply_chain_nodes ADD COLUMN IF NOT EXISTS status VARCHAR(50);
