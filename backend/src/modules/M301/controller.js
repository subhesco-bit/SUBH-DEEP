...
class M301Controller {
  ...
  async getById(req, res) {
    try {
      const { id } = req.params;
      const result = await m301Service.getById(id);
  ...
  async create(req, res) {
    try {
      ...
      const result = await m301Service.create({ user_id, ...data });
  ...
  async update(req, res) {
    try {
      const { id } = req.params;
      const result = await m301Service.update(id, req.body);
      return sendSuccess(res, result);
    } catch (error) {
  ...
  async delete(req, res) {
    try {
      const { id } = req.params;
      const result = await m301Service.delete(id);
      return sendSuccess(res, result);
    } catch (error) {
  ...
  async search(req, res) {
    try {
      ...
      const result = await m301Service.search(q, fields ? fields.split(',') : undefined);
      return sendSuccess(res, result);
    } catch (error) {
...
module.exports = new M301Controller();