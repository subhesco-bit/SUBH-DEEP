/**
 * climateRouteSupport — shared request-hardening helpers for route modules.
 *
 ...
 *
 * Exports: bodyValidator, queryValidator, date, dateTime, enumValue, numberValue, fail, invalid, requestId, validateId, parsePageQuery
 * Consumers: weatherRoutes.js
 *
 * Why it needed recovering:
 * 2e3420a1 corrupted this file and 441c87e4 replaced it with a 12-line router stub.
 *
