/**
 * Routes for the 6 Community-domain CRUD resources - see
 * backend/src/services/communityManagementService.js. Mounted at flat
 * prefixes in index.js matching frontend/src/services/api.js exactly
 * (e.g. /api/v1/blocks), so no frontend change is needed.
 */
...
const routes = {
  ...
  stateManagementRoutes: crudRouter(stateManagement),
  producerGroupRoutes: crudRouter(producerGroup),
  communityAssetRoutes: crudRouter(communityAsset),
