/**
 * enterpriseRouteSupport — shared request-hardening helpers for route modules.
 *
 * Recovered 2026-09-13 from git 2e3420a1^, per
 ...
 *
 * Exports: protectRouter, requireHumanAuthorization, correlationId, fail
 * Consumers: rfqRoutes.js, decisionSupportRoutes.js
 *
 * Why it needed recovering:
 * 2e3420a1 ("Batch middleware and syntax repairs on 358 route files") corrupted this
 * file, and 441c87e4 ("replace corrupted support files") then replaced it with a
 * 17-line router stub exporting only a /health route.
 *
