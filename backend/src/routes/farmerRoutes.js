/**
 * farmerRoutes — the canonical implementation for this resource.
 *
 * Consolidated from farmerRoutes_merged.js on 2026-09-13, per
...
router.get('/health', (req, res) => {
  res.json({ success: true, status: 'healthy', module: 'farmerRoutes' });
});
