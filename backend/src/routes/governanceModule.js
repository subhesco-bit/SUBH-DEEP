/**
 * governanceModule — the canonical implementation for this resource.
 *
 * Consolidated from platform/governanceModule_merged.js on 2026-09-13, per
 * .ai/decisions/0001-module-lineage-consolidation.md.
 *
 * Covers villages, panchayats, CSR projects, compliance reports and cooperatives — 24 database-backed endpoints.
 *
...
router.get('/health', (req, res) => {
  res.json({ success: true, module: 'governanceModule', status: 'operational' });
});
