/**
 * Routes for the 3 Irrigation-domain CRUD resources - see
 * backend/src/services/legacy/irrigationManagementService.js. Mounted at
 * flat prefixes in index.js matching frontend/src/services/api.js exactly
 * (/api/v1/irrigation/schedules, /api/v1/irrigation/water-sources,
 * /api/v1/irrigation/logs), so no frontend change is needed.
 */
...
const {
  irrigationSchedules, irrigationWaterSources, irrigationLogs,
