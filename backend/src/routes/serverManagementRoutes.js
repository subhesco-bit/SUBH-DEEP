 ...
 * substantial 566-line real file existed only there; the live
 * routes/platform/serverManagementRoutes.js was a thin 39-line in-memory
 * scaffold). Verified every method against the live
 * services/serverManagementService.js before mounting. Added
 * authMiddleware + adminMiddleware - the recovered file had zero auth
 * despite exposing server provisioning/deletion and load-balancer/backup
 * management.
 */
