/**
 * weatherRoutes — the canonical implementation for this resource.
 *
 * Consolidated from weatherRoutes_merged.js on 2026-09-13, per
...
router.get('/health', (req, res) => {
  res.json({ success: true, status: 'healthy', module: 'weatherRoutes' });
});
