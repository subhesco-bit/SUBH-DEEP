/**
 * advancedAIService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/advancedAIService.js
...
module.exports = require('./legacy/advancedAIService.js');
