/**
 * advancedFeaturesService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/advancedFeaturesService.js
...
module.exports = require('./legacy/advancedFeaturesService.js');
