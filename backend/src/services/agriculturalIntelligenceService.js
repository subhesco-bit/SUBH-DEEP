/**
 * agriculturalIntelligenceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/agriculturalIntelligenceService.js
...
module.exports = require('./legacy/agriculturalIntelligenceService.js');
