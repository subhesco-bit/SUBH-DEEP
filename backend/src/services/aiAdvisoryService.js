/**
 * aiAdvisoryService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/aiAdvisoryService.js
...
module.exports = require('./legacy/aiAdvisoryService.js');
