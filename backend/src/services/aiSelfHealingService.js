/**
 * aiSelfHealingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/aiSelfHealingService.js
...
module.exports = require('./legacy/aiSelfHealingService.js');
