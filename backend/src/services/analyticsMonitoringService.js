/**
 * analyticsMonitoringService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/analyticsMonitoringService.js
...
module.exports = require('./legacy/analyticsMonitoringService.js');
