/**
 * biodiversityService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/biodiversityService.js
...
module.exports = require('./legacy/biodiversityService.js');
