/**
 * coldStorageService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/coldStorageService.js
...
module.exports = require('./legacy/coldStorageService.js');
