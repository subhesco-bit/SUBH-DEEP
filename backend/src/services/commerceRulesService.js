/**
 * commerceRulesService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/commerceRulesService.js
...
module.exports = require('./legacy/commerceRulesService.js');
