/**
 * consumerHealthService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/consumerHealthService.js
...
module.exports = require('./legacy/consumerHealthService.js');
