/**
 * cooperativeShareService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/cooperativeShareService.js
...
module.exports = require('./legacy/cooperativeShareService.js');
