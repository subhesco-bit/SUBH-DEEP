/**
 * custodyEventRoutes (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/custodyEventRoutes.js
...
module.exports = require('./legacy/custodyEventRoutes.js');
