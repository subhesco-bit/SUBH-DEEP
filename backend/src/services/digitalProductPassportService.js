/**
 * digitalProductPassportService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/digitalProductPassportService.js
...
module.exports = require('./legacy/digitalProductPassportService.js');
