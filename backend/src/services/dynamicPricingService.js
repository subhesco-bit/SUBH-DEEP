/**
 * dynamicPricingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/dynamicPricingService.js
...
module.exports = require('./legacy/dynamicPricingService.js');
