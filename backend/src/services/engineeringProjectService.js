/**
 * engineeringProjectService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/engineeringProjectService.js
...
module.exports = require('./legacy/engineeringProjectService.js');
