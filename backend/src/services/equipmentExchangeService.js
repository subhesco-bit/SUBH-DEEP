/**
 * equipmentExchangeService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/equipmentExchangeService.js
...
module.exports = require('./legacy/equipmentExchangeService.js');
