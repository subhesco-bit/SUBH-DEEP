/**
 * farmerTrainingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/farmerTrainingService.js
...
module.exports = require('./legacy/farmerTrainingService.js');
