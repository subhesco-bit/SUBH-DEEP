/**
 * geofencingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/geofencingService.js
...
module.exports = require('./legacy/geofencingService.js');
