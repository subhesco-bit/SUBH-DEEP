/**
 * glutWarningService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/glutWarningService.js
...
module.exports = require('./legacy/glutWarningService.js');
