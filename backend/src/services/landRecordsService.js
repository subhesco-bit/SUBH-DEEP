/**
 * landRecordsService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/landRecordsService.js
...
module.exports = require('./legacy/landRecordsService.js');
