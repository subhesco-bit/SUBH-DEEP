/**
 * livestockManagementService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/livestockManagementService.js
...
module.exports = require('./legacy/livestockManagementService.js');
