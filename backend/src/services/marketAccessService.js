/**
 * marketAccessService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/marketAccessService.js
...
module.exports = require('./legacy/marketAccessService.js');
