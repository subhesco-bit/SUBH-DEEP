/**
 * marketDataService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/marketDataService.js
...
module.exports = require('./legacy/marketDataService.js');
