/**
 * merchandisingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/merchandisingService.js
...
module.exports = require('./legacy/merchandisingService.js');
