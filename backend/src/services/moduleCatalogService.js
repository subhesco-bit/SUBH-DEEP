/**
 * moduleCatalogService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/moduleCatalogService.js
...
module.exports = require('./legacy/moduleCatalogService.js');
