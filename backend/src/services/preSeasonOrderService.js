/**
 * preSeasonOrderService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/preSeasonOrderService.js
...
module.exports = require('./legacy/preSeasonOrderService.js');
