/**
 * projectSystemsService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/projectSystemsService.js
...
module.exports = require('./legacy/projectSystemsService.js');
