/**
 * renewableEnergyService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/renewableEnergyService.js
...
module.exports = require('./legacy/renewableEnergyService.js');
