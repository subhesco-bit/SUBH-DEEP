/**
 * riskPricingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/riskPricingService.js
...
module.exports = require('./legacy/riskPricingService.js');
