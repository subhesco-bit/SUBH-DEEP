/**
 * ruralFinanceService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/ruralFinanceService.js
...
module.exports = require('./legacy/ruralFinanceService.js');
