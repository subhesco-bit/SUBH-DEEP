/**
 * soilTestingService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/soilTestingService.js
...
module.exports = require('./legacy/soilTestingService.js');
