/**
 * systemAdministrationService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/systemAdministrationService.js
...
module.exports = require('./legacy/systemAdministrationService.js');
