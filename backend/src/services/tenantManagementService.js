/**
 * tenantManagementService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/tenantManagementService.js
...
module.exports = require('./legacy/tenantManagementService.js');
