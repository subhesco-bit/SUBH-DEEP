-- Performance Analytics Schema (M083)
...
CREATE INDEX idx_performance_reports_entity ON performance_reports(entity_id, entity_type);
CREATE INDEX idx_performance_reports_period ON performance_reports(period_start, period_end);
CREATE INDEX idx_performance_trends_entity ON performance_trends(entity_id, entity_type);
CREATE INDEX idx_performance_comparisons_entity ON performance_comparisons(entity_id, entity_type);
CREATE INDEX idx_performance_targets_entity ON performance_targets(entity_id, entity_type);
CREATE INDEX idx_performance_drivers_entity ON performance_drivers(entity_id, entity_type);
CREATE INDEX idx_performance_alerts_entity ON performance_alerts(entity_id, entity_type);
