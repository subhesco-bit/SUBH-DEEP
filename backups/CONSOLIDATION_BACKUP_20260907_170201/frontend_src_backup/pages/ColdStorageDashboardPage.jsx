...
export default function ColdStorageDashboardPage() {
  ...
  // Fetch cold storage status
  const { data: status, isLoading: statusLoading } = useQuery({
    queryKey: ['cold-storage-status'],
    queryFn: () => coldStorageAPI.getStatus().then(res => res.data),
  ...
  const { data: facilities, isLoading: facilitiesLoading } = useQuery({
    ...
    queryFn: () => coldStorageAPI.getFacilities().then(res => res.data),
                  ...
                  {facilities?.map((facility) => (
                    <div key={facility.id} className="border rounded-lg p-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" variant="outline">Temperature Log</Button>
                        <Button 
                          size="sm"
        ...
        <TabsContent value="temperature">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Real-time temperature tracking across facilities</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                Temperature monitoring interface - requires additional implementation
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="compliance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Regulatory compliance and food safety standards</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                Compliance monitoring interface - requires additional implementation
              </div>
            </CardContent>
          </Card>
        </TabsContent>
