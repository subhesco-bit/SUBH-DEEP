...
The first launch geography is Nagaland, as already decided. Begin with one verified village/Panchayat cluster in Nagaland, artisans plus food producers, corporate procurement and CSR demand, milestone escrow, and assisted IVR/SMS access. District, languages, scheme authority, transport and seasonal data must be verified in implementation. The final discussion happens after the project is ready for concrete review.
