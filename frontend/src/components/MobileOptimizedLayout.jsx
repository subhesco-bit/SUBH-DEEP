...
const MobileOptimizedLayout = forwardRef(({ loading, error, disabled, children, className, ...props }, ref) => {
  const id = useId();
  const ariaDescribedBy = error ? \-error : undefined;

  return (
    <div role="region" aria-label="MobileOptimizedLayout component">
      <div
        ref={ref}
        role="group"
        aria-busy={loading}
...
MobileOptimizedLayout.propTypes = {
