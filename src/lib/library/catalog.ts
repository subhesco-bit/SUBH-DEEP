...
const DOCTRINE: LibraryCard[] = [
  ...
  },
  {
    id: "lib-share-hours",
    kind: "contract",
    title: "Village muscle books hours, never a rent",
    body: "Cold bay, mill, mobile and static process, pack, food/soil/animal labs, dryer, polyhouse, and the equipment pool are FPO muscle. Hours remaining conserve like grams. AI proposes a slot. A clerk confirms. Rental rupees stay missing. GST invoice stays missing.",
    source: "src/lib/share/book.ts",
    organs: ["shared", "processing", "warehouse", "fpo"],
    signal: "share.booked",
  },
  {
    id: "lib-organic-trace",
    kind: "principle",
    title: "Organic is a declared path on the same sack",
    body: "PGS or NPOP is a clerk fact on the lot body. The path is mint → intake → process → pack. A certificate rupee is not invented. Pack may name an HSN. The GST invoice stays missing.",
    source: "src/lib/share/trace.ts",
    organs: ["trace", "lot", "shared"],
    signal: "organic.traced",
  },
  {
    id: "lib-gst-named",
    kind: "principle",
    title: "HSN may name the sack. GST does not post.",
    body: "Packaging as per GST is an HSN analog with rate blank. Operation Green and NE logistics eligibility may compute. Amount stays undeclared. Disbursement rails stay missing.",
    source: "src/lib/share/gst.ts",
    organs: ["erp", "scheme", "shared"],
    signal: "gst.invoice",
  },
  {
    id: "lib-energy-cloud",
